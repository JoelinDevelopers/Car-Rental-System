...
import { FaCar, FaCog, FaEdit, FaTimes, FaFilter, FaGasPump, FaTachometerAlt, FaTrash, FaUser } from "react-icons/fa";
...
const StatCard = ({ title, value, icon: Icon, className = ""}) => (
  <div  
    className={`${styles.gradientOrange} ${styles.rounded2xl} ${styles.statCard} ${styles.borderGray}
...
const CarCard = ({ car, onEdit, onDelete }) => {
  ...
  return (
    <div
      className={`${styles.gradientGray} ${styles.rounded2xl} ${styles.borderGray} ${styles.borderHoverOrange}`}
    >
      <div className="relative">
        <img
          src={car.image}
          alt={`${car.make} ${car.mdel}`}
...
const NoCarsView = ({ onResetFilter }) => (
  <div className={`${styles.gradientGray} ${styles.noCarsContainer}`}>
    <div className="mx-auto w-24 h-24 rounded-full bg-linear-to-br from-orange-900/30
    to-amber-900/30 flex items-center justify-center mb-6">
      <div className="bg-linear-to-br from-orange-700 to-amber-700 w-16 h-16 flex rounded-full
...
const ManageCarPage = () => {
  ...
  return (
   <div className="min-h-screen bg-gray-950 p-4 sm:p-6">
    ...
    <div className="bg-gary-900/50 backdrop-blur-sm rounded-2xl p-5 mb-6 border border-gray-800">
