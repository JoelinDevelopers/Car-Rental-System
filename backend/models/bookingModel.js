...
const bookingSchema = new Schema(
  {
    ...
    // ID and License Photos (Cloudinary)
    idPhoto: { type: String, default: "" },
    idPhotoCloudinaryId: { type: String, default: "" },
    licensePhoto: { type: String, default: "" },
    licensePhotoCloudinaryId: { type: String, default: "" },
...
/* -------------------- Post Save -------------------- */
/* Optional: keep booking history on Car */
